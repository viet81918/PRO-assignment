...
public class Validation {
    ...
    public static String getValidStringInput() {
        ...
        while (true) {
            ...
            if (!input.isEmpty() && Pattern.matches("[a-z A-Z]+", input)) {
                ...
                System.out.println(
                        "Invalid input. Please enter a valid non-empty string without special characters or digits.");
            }
        }
    }

    public static boolean checkIDcus(String ID) {
    ...
    public static boolean checkType(String Type1) {
        ...
        if (Type.equalsIgnoreCase(regex) || Type.equalsIgnoreCase(regex1) || Type.equalsIgnoreCase(regex2)
                || Type.equalsIgnoreCase(regex3) || Type.equalsIgnoreCase(regex4)) {
            return true;
        } else {
